...
namespace config {
  ...
  // QVBR / HQVBR / HQCBR values mirror the AMF v1.5.x SDK enums
  // (AMF_VIDEO_ENCODER_AV1_RATE_CONTROL_METHOD_ENUM in VideoEncoderAV1.h)
  // so the non-Windows fallback stays in sync with the Windows branch.
  ...
  // QVBR / HQVBR / HQCBR mirror VideoEncoderHEVC.h's
  // AMF_VIDEO_ENCODER_HEVC_RATE_CONTROL_METHOD_ENUM (successive values
  // after PEAK_CONSTRAINED_VBR).
  ...
  // QVBR / HQVBR / HQCBR mirror VideoEncoderVCE.h's
  // AMF_VIDEO_ENCODER_RATE_CONTROL_METHOD_ENUM (successive values after
